...
//        jpqlQuery.leftJoin(reply).on(reply.customRecipe.eq(customRecipe));//(CustomRecipeReply entity의 fk = CustomRecipe entity의 pk) 조건의 left join 연산
//
//
...
//    }
    ...
    public Page<Object[]> searchPage(String type, String keyword, Pageable pageable) {
        ...
        jpqlQuery.leftJoin(reply).on(reply.customRecipe.eq(customRecipe));

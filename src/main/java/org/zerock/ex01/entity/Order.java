...
//OrderProduct에 있는 order에 의해 관리 된다는 의미 +고아객체 제거하기
    ...
    //상품 주문한 회원의 정보를 세팅
    public static Order createOrder(User user, List<OrderProduct> orderProductList, String imp_uid, String preceipt_url) {
        ...
        order.setPreceipt_url(preceipt_url);
        return order;
    }
